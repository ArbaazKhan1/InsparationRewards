...
class CreateProfileAPIAsyncTask extends AsyncTask<String,Void, String> {
    private static final String TAG = "CreateProfileAPIAsyncTa";
    CreateProfileActivity profileActivity;
    public CreateProfileAPIAsyncTask(CreateProfileActivity profileActivity) {
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            object.put("pointsToAward",1000);
            object.put("department",strings[4]);
            object.put("story",strings[5]);
            object.put("position",strings[6]);
            object.put("admin",admin);
            object.put("location",strings[8]);
            object.put("imageBytes",strings[9]);
