...
public class GetAllProfilesAPIAyncTask extends AsyncTask<String,Void, String>  {
    private static final String TAG = "GetAllProfilesAPIAyncTa";
    ...
    protected void onPostExecute(String s) {
        ...
        leaderboardActivity.listofUsers(s);
    }
}
